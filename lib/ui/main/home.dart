                  ...
                  child: Column(children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          height: 280,
                          child: vm.isGenerSelected || vm.homeScreenLoading
                              ? ListView.separated(
                                  scrollDirection: Axis.horizontal,
                                  itemBuilder: (context, i) {
                                    return Column(
                                        ...
                                        children: [
                                          Skelton(height: 200, width: 135),
                                          const SizedBox(height: 10),
                                          Skelton(height: 10, width: 135),
                                          const SizedBox(height: 10),
                        ...
                        Container(
                          ...
                          child: Padding(
                              ...
                              child: vm.homeScreenLoading
                                  ...
                                  : ListView.separated(
                                      scrollDirection: Axis.horizontal,
                                      itemCount: vm.collectionBooks.length,
                                      itemBuilder: (context, i) {
                                        return collectionBooks(
                                            ...
                                            image: vm
                                                .collectionBooks[i].image1.url,
                                            title:
                                                vm.collectionBooks[i].bookName,
                                            quality: '12');
                                      },
                                      separatorBuilder:
                        ...
                        //   height: 25,
                        // ),
                        (vm.featuredBooks.isEmpty && !vm.homeScreenLoading)
                            ? SizedBox()
                            : Container(
                                child: Padding(
                                padding: const EdgeInsets.all(10.0),
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DiningVM>(builder: (vm) {
      return FadeAnimation(
        1.4,
        Container(
            height: vm.homeScreenLoading
                ? 4 * 240
                : (vm.featuredBooks.length * 240),
            // padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
            child: vm.homeScreenLoading
                ? ListView.separated(
                    physics: const NeverScrollableScrollPhysics(),
